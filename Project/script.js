...
function currentWeather(city) {
    ...
    $.ajax({
        ...
        // Check weather conditions and display alerts
        checkWeatherConditions(response);
...
// Function to check weather conditions and display alerts
function checkWeatherConditions(response) {
    // Check for rainy weather (you can adjust the criteria as needed)
    if (response.weather[0].main.toLowerCase().includes('rain')) {
        // Show a rainy weather alert
        alert("It's raining in " + response.name + ". Don't forget your umbrella!");
    }

    // Check for hot weather (you can adjust the temperature threshold as needed)
    var temperatureCelsius = response.main.temp - 273.15;
    if (temperatureCelsius > 30) {
        // Show a hot weather alert
        alert("It's hot in " + response.name + ". Stay hydrated and wear sunscreen!");
    }
}

// Update the currentWeather function to include the checkWeatherConditions function
function currentWeather(city) {
    // ... (your existing code)
